...
\newenvironment{sidebar}[1][]{%
  ...
  % Create the sidebar
  % \section[\@csm@sb@title]{Sidebar:~\@csm@sb@title}
...
\def\csm@sb@queue@title{}
\def\csm@sb@queue@label{}
\def\csm@sb@queue@side{}
\def\csm@sb@queue@position{}
\def\csm@sb@queue@columns{}
\def\csm@sb@queue@content{}
