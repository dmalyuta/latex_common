...
\newcommand{\flushsidebars}{
  ...
  \foreach \@i in {1,...,\thesidebar@queue@size} {
    \begin{sidebar}[%
      title={\list@nth{csm@sb@titles}{\@i}},
      label={\list@nth{csm@sb@labels}{\@i}},
      side={\list@nth{csm@sb@sides}{\@i}},
      position={\list@nth{csm@sb@positions}{\@i}},
      columns={\list@nth{csm@sb@columns}{\@i}}]
      \input{\list@nth{csm@sb@contents}{\@i}}
    \end{sidebar}
  }
