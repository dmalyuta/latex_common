...
\newcommand{\xombie}[1][]{
  ...
  \begin{scope}[shift={\@pos},rotate=\@tilt]
    \begin{scope}[xshift=-0.05cm]
      % External tank rear
      \begin{scope}[xshift=0.75cm]
        \fill[\@tank] (-0.45,-0.1) rectangle (-0.05,0.95);
      ...
      \begin{scope}[xshift=0.05cm,yshift=-0.95cm,rotate=\@gimbal]
      ...
      % Bottom tank walls
      \draw[fill=\@gold] (-0.45,-0.65) rectangle (0.55,0);
      
      % Center tank walls
      \draw[fill=\@silver@darker] (-0.45,0) rectangle (0.55,1);
...
\newcommand{\cg}[1][]{
  ...
  \begin{scope}[shift={\shift}]
    ...
    \draw[fill=white] (0,0) circle (\@cg@radius);
